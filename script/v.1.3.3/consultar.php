                    ...
                    <div>
                        <form id="form_consulta" class="form-pexsell" method="post">
                            ...
                            <div class="d-flex justify-content-center item-group">
								<input class="btn btn-primary pulse animated infinite rounded text-black text-uppercase" type="button" id="enviar_consulta" value="Enviar Consulta" name="enviar" style="animation-duration: 3s;">
							</div>
                        </form>
                    </div>
                </div>
