...
$url = "https://pex.website/mercadolibre/scraper-vendidos.php?id=".$id_producto;
//echo $url;
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <div>
						...
						$url = "https://pex.website/mercadolibre/scraper-vendidos.php?id=".$alternative;
						$sitioweb = curl($url);
						$info = json_decode($sitioweb);
						$imagen_principal = isset($info->pictures[0]->secure_url)? $info->pictures[0]->secure_url : 'assets/img/sin-imagen.png';
						...
						<div class="text-center p-2">
							<div class="row">
								...
								descargarYGuardarImagen($imagen_principal, 'tmpfiles', substr($alternative, 3)."-1");?>" alt="<?php echo $title;?>" width="250" height="250"></a></div>
            ...
            <div class="row mb-3">
                ...
                <?php
                    foreach ($alternativas as &$alternativa) {
                        ...
                        //CONSULTANDO DATOS DEL ITEM
                            $url = "https://pex.website/mercadolibre/scraper-vendidos.php?id=".$alternativa->id;
                            //$sitioweb = curl($url);
                            $sitioweb = file_get_contents($url);
                            $info = json_decode($sitioweb);
                            $imagen_principal = isset($info->pictures[0]->secure_url)? $info->pictures[0]->secure_url : 'assets/img/sin-imagen.png';
