                ...
                <div class="col-md-9">
					...
					<?php
						foreach ($results as &$producto) {
							...
							$url = "https://pex.website/mercadolibre/scraper-vendidos.php?id=".$id;
							$sitioweb = curl($url);
                            ...
                            <div class="text-center p-2">
                                <div class="row">
									...
									descargarYGuardarImagen($imagen_principal, 'tmpfiles', substr($id, 3)."-1");?>" alt="<?php echo $title;?>" width="250" height="250"></a></div>
