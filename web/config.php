<?php
	...
	$dbServer = "localhost";
	$dbName = "alquila2_web";
	$dbUsername = "alquila2_web";
	$dbPassword = "Z]u1?BEdo[@t";
	...
	$logo = 'https://alquila2.com.ar/assets/img/logo.svg';
	$icon = 'https://alquila2.com.ar/icon.png';
	$cdn = "486fe5ffbd1f01ba5d424c22be70ea3d";
	//PUBLICIDAD
	$adsense_categoria = '1111111111';
	$adsense_item = '2222222';
	$adsense_sidebar = '333333333';
