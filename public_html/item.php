                    ...
                    <div>
                        ...
                        <div class="d-flex justify-content-center my-3">
							<div class="btn-group botones" role="group">
								<a class="btn btn-primary rounded me-2 <?php filtro_ocultar($categoria_principal);?>" role="button" href="/comprar.php?idproducto=<?php echo preg_replace("/[^0-9]/", "", $id_producto);?>&sku=<?php echo base64_encode($id_producto);?>">COMPRAR</a>
								<a class="btn btn-primary rounded" role="button" href="/consultar.php?idproducto=<?php echo preg_replace("/[^0-9]/", "", $id_producto);?>&sku=<?php echo base64_encode($id_producto);?>">CONSULTAR</a>
							</div>
                        </div>
                        ...
                        <div class="text-end"><a class="badge bg-danger text-uppercase opacity-75 btn-denuncia rounded" href="/denuncia.php?idproducto=<?php echo preg_replace("/[^0-9]/", "", $id_producto);?>&sku=<?php echo base64_encode($id_producto);?>">Denunciar</a></div>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
						...
						if($condicion == 'new'){
							...
							<div class="col-md-3">
								<div class="text-center border bg-white p-2 rounded mb-3 producto-relacionado" onclick="location.href = &#39;/<?php echo $urlNew;?>&#39;">
									<img class="img-fluid list-product list-product-rel mb-1" loading="lazy" data-bss-hover-animate="tada" src="<?php echo change_image_extension($imagen_principal)?>" alt="<?php echo $alternativa->title;?>" width="250" height="250">
