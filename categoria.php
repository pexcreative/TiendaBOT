...
if(!isset($info->results)) {
	header('Location: categoria/MLA1000');
}
            ...
            <ol class="breadcrumb text-capitalize p-2 ps-3 rounded">
				...
				<?php
					foreach ($caterories as &$categoria) {
						echo '<li class="breadcrumb-item"><a href="/categoria/'.$categoria->id.'"><span>'.$categoria->name.'</span></a></li>';
					}
				?>
            </ol>
			<?php }?>
					...
					<?php
						foreach ($results as &$producto) {
                            ...
                            <div class="text-center p-2">
                                <div class="row">
                                    <div class="col-md-3"><a class="list-product" href="/<?php echo $urlNew;?>"><img data-bss-hover-animate="tada" class="producto list-product rounded" src="<?php echo descargarYGuardarImagen($imagen_principal) ;?>" alt="<?php echo $title;?>" height="160" width="160"></a></div>
